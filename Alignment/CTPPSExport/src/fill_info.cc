...
void InitFillInfoCollection()
{
    ...
    // 2016 post-TS2
    fillInfoCollection.push_back(FillInfo(5393, false, 282730, 282735, "fill 5393"));
    fillInfoCollection.push_back(FillInfo(5394, false, 282799, 282814, "fill 5394"));
    fillInfoCollection.push_back(FillInfo(5395, false, 282842, 282842, "fill 5395"));
    fillInfoCollection.push_back(FillInfo(5401, false, 282917, 282924, "fill 5401"));
    fillInfoCollection.push_back(FillInfo(5405, false, 283040, 283043, "fill 5405"));
    fillInfoCollection.push_back(FillInfo(5406, false, 283049, 283067, "fill 5406"));
    fillInfoCollection.push_back(FillInfo(5412, false, 283171, 283171, "fill 5412"));
    fillInfoCollection.push_back(FillInfo(5416, false, 283270, 283283, "fill 5416"));
    fillInfoCollection.push_back(FillInfo(5418, false, 283305, 283308, "fill 5418"));
    fillInfoCollection.push_back(FillInfo(5421, false, 283353, 283359, "fill 5421"));
    fillInfoCollection.push_back(FillInfo(5422, false, 283387, 283387, "fill 5422"));
    fillInfoCollection.push_back(FillInfo(5423, false, 283407, 283416, "fill 5423"));
    fillInfoCollection.push_back(FillInfo(5424, false, 283453, 283453, "fill 5424"));
    fillInfoCollection.push_back(FillInfo(5426, false, 283469, 283469, "fill 5426"));
    fillInfoCollection.push_back(FillInfo(5427, false, 283478, 283481, "fill 5427"));
    fillInfoCollection.push_back(FillInfo(5433, false, 283548, 283560, "fill 5433"));
    fillInfoCollection.push_back(FillInfo(5437, false, 283672, 283685, "fill 5437"));
    fillInfoCollection.push_back(FillInfo(5439, false, 283820, 283835, "fill 5439"));
    fillInfoCollection.push_back(FillInfo(5441, false, 283863, 283865, "fill 5441"));
    fillInfoCollection.push_back(FillInfo(5442, false, 283876, 283878, "fill 5442"));
    fillInfoCollection.push_back(FillInfo(5443, false, 283884, 283885, "fill 5443"));
    fillInfoCollection.push_back(FillInfo(5446, false, 283933, 283934, "fill 5446"));
    fillInfoCollection.push_back(FillInfo(5448, false, 283946, 283964, "fill 5448"));
    fillInfoCollection.push_back(FillInfo(5450, false, 284006, 284014, "fill 5450"));
    fillInfoCollection.push_back(FillInfo(5451, false, 284025, 284044, "fill 5451"));
	...
	fillInfoCollection.push_back(FillInfo(6402, false, 306896, 306897, "fill 6402"));
	fillInfoCollection.push_back(FillInfo(6404, false, 306926, 306929, "fill 6404"));
	fillInfoCollection.push_back(FillInfo(6405, false, 306936, 306936, "fill 6405"));
	fillInfoCollection.push_back(FillInfo(6411, false, 307014, 307017, "fill 6411"));
	fillInfoCollection.push_back(FillInfo(6413, false, 307042, 307063, "fill 6413"));
	fillInfoCollection.push_back(FillInfo(6415, false, 307073, 307076, "fill 6415"));
	fillInfoCollection.push_back(FillInfo(6417, false, 307082, 307082, "fill 6417"));
