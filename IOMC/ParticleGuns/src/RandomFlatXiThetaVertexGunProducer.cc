...
#include "IOMC/ParticleGuns/interface/RandomFlatXiThetaVertexGunProducer.h"
...
RandomFlatXiThetaVertexGunProducer::RandomFlatXiThetaVertexGunProducer(const edm::ParameterSet& pset) : 
...
void RandomFlatXiThetaVertexGunProducer::produce(edm::Event &e, const edm::EventSetup& es) 
{
  if (verbosity)
    printf("===================== %u:%llu =====================\n", e.id().run(), e.id().event());
...
void RandomFlatXiThetaVertexGunProducer::GenerateParticle(double z_sign, double mass, unsigned int barcode,
...
RandomFlatXiThetaVertexGunProducer::~RandomFlatXiThetaVertexGunProducer()
{
}
