...
###   
###     opticalFunctions = cms.VPSet(
###         cms.PSet( xangle = cms.double(120), fileName = cms.FileInPath("CalibPPS/ESProducers/data/optical_functions/2018/version4-test1/120urad.root") ),
###         cms.PSet( xangle = cms.double(130), fileName = cms.FileInPath("CalibPPS/ESProducers/data/optical_functions/2018/version4-test1/130urad.root") ),
###         cms.PSet( xangle = cms.double(140), fileName = cms.FileInPath("CalibPPS/ESProducers/data/optical_functions/2018/version4-test1/140urad.root") )
###     ),
###   
###     scoringPlanes = cms.VPSet(
###         # z in cm
