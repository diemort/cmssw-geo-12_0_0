...
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring('file:./_step3_inDQM_382027.root')
)
...
process.DQMHarvestCTPPS_step = cms.Path(process.ctppsDQMCalibrationHarvest)#DQMHarvestCTPPS)
process.dqmsave_step = cms.Path(process.DQMSaver)

# Schedule definition
process.schedule = cms.Schedule(process.DQMHarvestCTPPS_step,process.dqmsave_step)
