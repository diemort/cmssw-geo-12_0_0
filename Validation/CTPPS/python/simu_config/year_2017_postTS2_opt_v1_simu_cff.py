...
# beam optics for simulation - version 1
...
ctppsOpticalFunctionsESSource_SIMU = ctppsOpticalFunctionsESSource.clone(
  configuration = cms.VPSet(config_2017_v1),
  label = "SIMU"
)

ctppsInterpolatedOpticalFunctionsESSource_SIMU = ctppsInterpolatedOpticalFunctionsESSource.clone(
  opticsLabel = "SIMU"
)

ctppsDirectProtonSimulation.opticsLabel = "SIMU"
