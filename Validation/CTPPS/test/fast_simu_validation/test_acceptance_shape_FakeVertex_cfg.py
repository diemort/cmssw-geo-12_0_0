...
process.generator = cms.EDProducer("RandomFlatXiThetaVertexGunProducer",
  ...
  theta_x_sigma = cms.double(1000E-6), # in rad
  theta_y_mean = cms.double(0.),
  theta_y_sigma = cms.double(1000E-6),
  vertex_x_mean = cms.double(0.),
  vertex_x_sigma = cms.double(0.6), # in mm
  vertex_y_mean = cms.double(0.),
  vertex_y_sigma = cms.double(0.6),
...
process.ctppsTrackDistributionPlotter_reco = cms.EDAnalyzer("CTPPSTrackDistributionPlotter",
  ...
  outputFile = cms.string("output_shapeFakeVertexLarger.root")
)
...
#                                         'keep CTPPSPixelLocalTrackedmDetSetVector_ctppsPixelLocalTracks_*_*',
  ...
  fileName = cms.untracked.string("SimulatedTracksFakeVertexLarger.root")
)
